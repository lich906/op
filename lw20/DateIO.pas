...
TYPE
  ...
  Date = RECORD
           ...
           Day: DayNum
         END;
PROCEDURE WriteDate(VAR FOut: TEXT; VAR Res: Date); {Выводит дату в формате МЕС ДЕНЬ в файл}
PROCEDURE ReadDate(VAR FIn: TEXT; VAR Res: Date); {Читает дату из файла}
PROCEDURE CopyOut(VAR DateFile: FileOfDate); {Выводит даты из файла в OUTPUT каждую в новой строке}
